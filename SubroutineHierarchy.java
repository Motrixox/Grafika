...
public class SubroutineHierarchy extends JPanel {
	...
	private void drawWorld(Graphics2D g2) {
		...
		rotatingPolygon(g2, 0.85 * n1,1 * n1, -0.8, -0.6);
		rotatingPolygon(g2, 0.85 * n1,1 * n1, 1.8, -1.25);
		rotatingPolygon(g2, 0.85 * n2,1 * n2, -3.2, 2.15);
		rotatingPolygon(g2, 0.85 * n2,1 * n2, -1, 1.55);
		rotatingPolygon(g2, 0.85 * n3,1 * n3, 1.6, 2.05);
		rotatingPolygon(g2, 0.85 * n3,1 * n3, 3.4, 1.55);
		
		Rectangle(g2, 3, 0.2, 0.5, -0.9);
		Rectangle(g2, 2.5, 0.15, -2.1, 1.85);
		Rectangle(g2, 2, 0.1, 2.5, 1.8);
		
		Triangle(g2, 0.6, 2, 0.5, -2.9, Color.BLUE);
		Triangle(g2, 0.55, 1.6, -2.1, 0.3, new Color(122, 39, 195));
		Triangle(g2, 0.5, 1.2, 2.5, 0.6, new Color(0, 128, 0));
	...
	private void Rectangle(Graphics2D g2, double scale_x, double scale_y, double translate_x, double translate_y) {
	...
	private void Triangle(Graphics2D g2, double scale_x, double scale_y, double translate_x, double translate_y, Color color) {
		AffineTransform saveTransform = g2.getTransform();
		Color saveColor = g2.getColor();
		g2.setColor(color);
		g2.translate(translate_x, translate_y);
	...
	private void rotatingPolygon(Graphics2D g2, double scale_x, double scale_y, double translate_x, double translate_y) {
		AffineTransform saveTransform = g2.getTransform();
		Color saveColor = g2.getColor();
