...
public class SceneGraph extends JPanel {
	...
	private void createWorld() {
		...
		polygon1 = new TransformedObject(Polygon);
		polygon2 = new TransformedObject(Polygon);
		polygon3 = new TransformedObject(Polygon);
		polygon4 = new TransformedObject(Polygon);
		polygon5 = new TransformedObject(Polygon);
		polygon6 = new TransformedObject(Polygon);
		...
		polygon1.setScale(0.85 * n1,1 * n1); 
		polygon2.setScale(0.85 * n1,1 * n1); 
		polygon3.setScale(0.85 * n2,1 * n2); 
		polygon4.setScale(0.85 * n2,1 * n2); 
		polygon5.setScale(0.85 * n3,1 * n3);
		polygon6.setScale(0.85 * n3,1 * n3);
		triangle1.setScale(0.6,2).setColor(Color.blue); 
		triangle2.setScale(0.55,1.6).setColor(new Color(122, 39, 195)); 
		triangle3.setScale(0.5,1.2).setColor(new Color(0, 128, 0)); 
		rectangle1.setScale(3,0.2).setColor(Color.red); 
		rectangle2.setScale(2.5,0.15).setColor(Color.red); 
		rectangle3.setScale(2,0.1).setColor(Color.red); 
		
		polygon1.setTranslation(-0.8, -0.6);
		polygon2.setTranslation(1.8, -1.25);
		polygon3.setTranslation(-3.2, 2.15);
		polygon4.setTranslation(-1, 1.55);
		polygon5.setTranslation(1.6, 2.05);
		polygon6.setTranslation(3.4, 1.55);
		triangle1.setTranslation(0.5, -2.9);
		triangle2.setTranslation(-2.1, 0.3);
		triangle3.setTranslation(2.5, 0.6);
		rectangle1.setRotation(-15).setTranslation(0.5, -0.9);
		rectangle2.setRotation(-15).setTranslation(-2.1, 1.85);
		rectangle3.setRotation(-15).setTranslation(2.5, 1.8);
