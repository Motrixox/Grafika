...
public class Lab6 extends GLJPanel implements GLEventListener  {
	...
	void podstawa(GL2 gl2, float[][] w, int m) {
		...
		for (int i = 0; i < m; i++) {
			gl2.glMaterialfv(gl2.GL_FRONT_AND_BACK,gl2.GL_AMBIENT_AND_DIFFUSE,materials[1],2);
	...
	void sciana(GL2 gl2, float[][] w, int n, int m) {
		if(n == 0) {
			...
			gl2.glMaterialfv(gl2.GL_FRONT_AND_BACK,gl2.GL_AMBIENT_AND_DIFFUSE,materials[11],2);
			gl2.glVertex3f(w[n][0], 0.0f, w[n][1]);
			gl2.glMaterialfv(gl2.GL_FRONT_AND_BACK,gl2.GL_AMBIENT_AND_DIFFUSE,materials[11],6);
			gl2.glVertex3f(w[m-1][0], 0.0f, w[m-1][1]);
			gl2.glMaterialfv(gl2.GL_FRONT_AND_BACK,gl2.GL_AMBIENT_AND_DIFFUSE,materials[11],10);
	...
	public void init(GLAutoDrawable drawable) {
		...
		gl2.glLightfv(GL2.GL_LIGHT1,GL2.GL_AMBIENT ,white,0);
		gl2.glLightfv(GL2.GL_LIGHT1,GL2.GL_DIFFUSE ,white,0);
